...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  const prefix = (
    baseURL === undefined ? 'https://api.spotify.com/v1' : baseURL
  ).replace(/\/$/, '')
        ...
        tracks: {
          ...
          put: (option: {
            ...
            fetch<
              ...
              BasicHeaders,
              Methods4['put']['status']
            >(prefix, `${prefix0}${PATH4}`, PUT, option).json(),
          ...
          $put: (option: {
            ...
            fetch<
              ...
              BasicHeaders,
              Methods4['put']['status']
            >(prefix, `${prefix0}${PATH4}`, PUT, option)
              .json()
              .then((r) => r.body),
          ...
          delete: (option: {
            ...
            >(prefix, `${prefix0}${PATH4}`, DELETE, option).json(),
          /**
           * Remove one or more items from a user's playlist.
           * @returns A snapshot ID for the playlist
           */
          $delete: (option: {
            ...
            fetch<
              ...
              BasicHeaders,
              Methods4['delete']['status']
            >(prefix, `${prefix0}${PATH4}`, DELETE, option)
              .json()
              .then((r) => r.body),
